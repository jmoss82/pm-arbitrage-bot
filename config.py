...
ARB_ENTRY_MAX_SECONDS_IN_WINDOW = int(os.getenv("ARB_ENTRY_MAX_SECONDS_IN_WINDOW", "600"))
ARB_ENTRY_COOLDOWN_SECONDS_AFTER_ROLLOVER = int(
    os.getenv("ARB_ENTRY_COOLDOWN_SECONDS_AFTER_ROLLOVER", "20")
)
ARB_FORCE_EXIT_SECONDS_REMAINING = int(os.getenv("ARB_FORCE_EXIT_SECONDS_REMAINING", "120"))
